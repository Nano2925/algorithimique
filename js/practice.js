...
// Et afficher le resultat dans la console
    let message = ('Je decouvre le javascript')
    console.log(message + " et je suis très heureux de tout ce que j'apprend")
...
/*
    ...
    function animal(x){
        ...
        } else if (x == "lion" || "tigre"){
            console.log("Vous aimez les animaux sauvages !")
        } else if (x == "dauphin" || "otarie"){
...
// 'Je suis une boucle'
    for(let i = 0; i <= 5; i++){
        console.log(`${i} Je suis une boucle`)
    }
...
// '5 x 2 = 10'
// '5 x 3 = 15'
    let number3 = prompt("chosir un numéro")
    for (let i = 0; i <= 10; i++) {
        let res = i * number3;
        console.log(`${i} x ${number3} = ${res}`);
    }
...
// Afficher dans la console la note de l'utilisateur à l'indice